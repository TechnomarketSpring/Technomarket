	...
	<body>
		...
		<cs:if test="${ added != null }">
			...
			<form action="<cs:url value='/product/insert_product'/>" method="post" enctype="multipart/form-data">
				...
				<input type="number" id="price" name="price" value="price" min="0" required><br>
				<label for="warranty">Гаранция в месеци</label>
				<input type="number" id="warranty" name="warranty" value="warranty" min="0" required><br>
				<label for="promo">Промоционален процент</label>
				<input type="number" id="promo" name="promoPercent" value="promo" min="0" required><br>
